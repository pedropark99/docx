...
namespace docx {
    ...
    class Document {
        ...
        std::vector<docx::Section> sections;
        // std::vector<docx::Table> tables;
    ...
    class Paragraph {
        public:
        int section_index;
        docx::ParagraphProperties paragraph_properties;
        docx::RunOfContents paragraph_contents;

    };


    class ParagraphProperties {
        std::vector<rapidxml::xml_node> properties;
    }


    class RunOfContents {
        docx::TextNode text_node;
    };
